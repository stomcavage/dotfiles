...
export PATH=$HOME/.rbenv/bin:$HOME/.rbenv/plugins/ruby-build/bin:.cabal-sandbox/bin:$HOME/.cabal/bin:$HOME/Library/Haskell/bin:$PATH:/usr/local/opt/go/libexec/bin
